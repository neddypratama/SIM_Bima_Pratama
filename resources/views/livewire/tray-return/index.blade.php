    ...
    public function updateStatus(): void
    {
        DB::transaction(function () {
            ...
            if ($this->status == 'Selesai') {
                ...
                $invoiceStok = 'INV-' . $tanggal . '-TRY-' . $str;
                $invoiceHpp = 'INV-' . $tanggal . '-HPP-' . $str;

                // =============================
                // KATEGORI
                // =============================
                $kategoriStok = Kategori::where('name', 'Stok Tray')->first();
...
<div class="p-4 space-y-6">
    ...
    <x-modal wire:model="statusModal" title="Ubah Status Transaksi" separator>
        <div class="space-y-4">
            ...
            <x-select label="Status Baru" wire:model="status" placeholder="Pilih Status" :options="[
