...
new class extends Component {
    ...
    {
        return [
            'transaksis' => Transaksi::where('type', 'Kredit')->whereHas('details.kategori', fn($q) => $q->where('name', 'like', 'Penjualan Obat%'))->get()->map(
                fn($t) => [
                    'id' => $t->id,
    ...
    public function updatedTransaksisId($value): void
    {
        ...
        $this->name = 'Retur Penjualan dari ' . $transaksi->invoice;
    ...
    public function save(): void
    {
        ...
        $this->success('Retur berhasil dibuat!', redirectTo: '/obat-return');
    }
};
?>
...
<div class="p-4 space-y-6">
    ...
    <x-form wire:submit="save">
        ...
        <x-slot:actions>
            <x-button label="Cancel" link="/obat-return" />
