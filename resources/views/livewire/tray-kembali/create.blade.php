...
new class extends Component {
    ...
    {
        return [
            'transaksis' => Transaksi::where('type', 'Debit')->where('invoice', 'like', '%-TRY-%')->whereHas('details.kategori', fn(Builder $q) => $q->where('name', 'like', '%Stok Tray%'))->orderBy('tanggal', 'desc')->get()->map(
                fn($t) => [
                    'id' => $t->id,
    ...
    public function save(): void
    {
        ...
        $this->success('Retur berhasil dibuat!', redirectTo: '/tray-kembali');
    }
};
?>
...
<div class="p-4 space-y-6">
    ...
    <x-form wire:submit="save">
        ...
        <x-slot:actions>
            <x-button label="Cancel" link="/tray-kembali" />
