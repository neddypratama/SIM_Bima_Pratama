...
new class extends Component {
    ...
    public function export(): mixed
    {
        ...
        return Excel::download(new HutangExport($this->startDate, $this->endDate), 'hutang.xlsx');
    }
    ...
    public function with(): array
    {
        ...
        return [
            ...
            'client' => Client::all(),
            'kategori' => Kategori::whereHas('detailKategori', function (Builder $q) {
                $q->where(function ($q) {
                    $q->where('type', 'like', '%Liabilitas%');
                });
            })->get(),
...
<div class="p-4 space-y-6">
    ...
    <x-card class="overflow-x-auto">
        <x-table :headers="$headers" :rows="$transaksi" :sort-by="$sortBy" with-pagination
            link="hutang/{id}/show?invoice={invoice}">
