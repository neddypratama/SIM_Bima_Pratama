...
<div class="p-4 space-y-6">
    <x-header title="Create Transaksi Pembelian Telur" separator progress-indicator />
    ...
    <x-form wire:submit="save">
        ...
        <x-slot:actions>
            <div class="flex flex-row sm:flex-row gap-2 justify-end">
                ...
                <x-button spinner icon="o-paper-airplane" label="Save" type="submit" class="btn-primary" />
            </div>
        </x-slot:actions>
    </x-form>
</div>
