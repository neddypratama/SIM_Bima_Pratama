...
new class extends Component {
    ...
    {
        return [
            'transaksis' => Transaksi::where('type', 'Debit')->where('invoice', 'like', '%-STR-%')->whereHas('details.kategori', fn(Builder $q) => $q->where('name', 'like', '%Stok Pakan%'))->orderBy('tanggal', 'desc')->get()->map(
                fn($t) => [
                    'id' => $t->id,
    ...
    public function updatedTransaksisId($value): void
    {
        ...
        $this->invoice = 'INV-' . $tanggal . '-RTR-' . Str::upper(Str::random(4));
    ...
    public function save(): void
    {
        ...
        $this->success('Retur berhasil dibuat!', redirectTo: '/sentrat-kembali');
    }
};
?>
...
<div class="p-4 space-y-6">
    ...
    <x-form wire:submit="save">
        ...
        <x-slot:actions>
            <x-button label="Cancel" link="/sentrat-kembali" />
