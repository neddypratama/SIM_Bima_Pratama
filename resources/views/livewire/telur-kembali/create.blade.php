...
new class extends Component {
    ...
    {
        return [
            'transaksis' => Transaksi::where('type', 'Debit')->where('invoice', 'like', '%-TLR-%')->whereHas('details.kategori', fn(Builder $q) => $q->where('name', 'like', '%Stok Telur%'))->orderBy('tanggal', 'desc')->get()->map(
                fn($t) => [
                    'id' => $t->id,
    ...
    public function save(): void
    {
        ...
        $this->success('Retur berhasil dibuat!', redirectTo: '/telur-kembali');
    }
};
?>
