...
new class extends Component {
    ...
    public function export(): mixed
    {
        ...
        return Excel::download(new PembelianObatExport($this->startDate, $this->endDate), 'pembelian-obat.xlsx');
    }
    ...
    public function transaksi(): LengthAwarePaginator
    {
        return Transaksi::query()
            ...
            ->where('type', 'Debit')
            ->whereHas('kategori', fn(Builder $q) => $q->where('name', 'like', '%Stok Obat%'))
...
<div class="p-4 space-y-6">
    <x-header title="Transaksi Pembelian Obat" separator progress-indicator>
        <x-slot:actions>
            <div class="flex flex-row sm:flex-row gap-2">
                ...
                <x-button label="Create" link="/obat-masuk/create" responsive icon="o-plus" class="btn-primary" />
            </div>
        </x-slot:actions>
    </x-header>
