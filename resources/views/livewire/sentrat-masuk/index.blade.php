...
new class extends Component {
    ...
    public function export(): mixed
    {
        ...
        return Excel::download(new PembelianSentratExport($this->startDate, $this->endDate), 'pembelian-sentrat.xlsx');
    }
...
<div>
    <x-header title="Transaksi Pembelian Sentrat" separator progress-indicator>
        <x-slot:actions>
    ...
    <x-card>
        <x-table :headers="$headers" :rows="$transaksi" :sort-by="$sortBy" with-pagination
            link="sentrat-masuk/{id}/edit?invoice={invoice}">
            ...
            @scope('actions', $transaksi)
                <div class="flex">
                    ...
                    <x-button icon="o-eye" link="/sentrat-masuk/{{ $transaksi->id }}/show?invoice={{ $transaksi->invoice }}"
